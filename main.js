...
const editItem = (e) => {
  ...
  submitBtn.textContent = "Edit"; //* Düzenle butonuna tıklanıldığında Ekle butonu Düzenle olarak değişsin.
  console.log(editID);
};
...
const deleteItem = (e) => {
  ...
  displayAlert("Successfully Removed", "danger"); //* Ekrana gönderdiğimiz parametrelere göre bildirim bastırır.
